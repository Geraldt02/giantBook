...
@section('content')
    <div class="bg-secondary text-warning fs-3 ps-4 pt-3">
        Publisher Detail :
    </div>

    <div>
        <div class="bg-secondary text-light fs-3 ps-4 ">
        Publisher Name : {{$publisher->name}} <br>
        Address : {{$publisher->address}} <br>
        Phone : {{$publisher->phone}} <br>
        Email : {{$publisher->email}} <br>
    </div>

    <div class="bg-secondary text-warning fs-3 ps-4 pb-3">
